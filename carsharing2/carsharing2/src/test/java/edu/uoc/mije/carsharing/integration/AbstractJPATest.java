...
import edu.uoc.mije.carsharing.business.trip.TripFacadeBean;
import edu.uoc.mije.carsharing.business.tripadmin.TripAdminFacadeBean;
import edu.uoc.mije.carsharing.business.user.UserFacadeBean;
...
public abstract class AbstractJPATest {
    ...
    public static Archive<?> createDeployment() {		
		JavaArchive jar = ShrinkWrap.create(JavaArchive.class)
	            ...
	            .addPackage(PassengerInTripException.class.getPackage())
	            .addPackage(CommunicationFacadeBean.class.getPackage())
	            .addPackage(TripFacadeBean.class.getPackage())
	            .addPackage(TripAdminFacadeBean.class.getPackage())
	            .addPackage(UserFacadeBean.class.getPackage())
